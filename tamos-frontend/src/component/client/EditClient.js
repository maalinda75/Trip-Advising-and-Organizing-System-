...
<link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'></link>
	...
	<section id="content">
		...
		<main>
			<h1 class="title">Edit Clients</h1>
			<ul class="breadcrumbs">
				<li><a href="/view-clients">All Clients</a></li>
				<li class="divider">/</li>
				<li><a href="#" class="active">Edit Clients</a></li>
			</ul>
  ...
  <li><a href="#">Remove</a></li>*/}
        ...
        <div className="input-group mb-5">
          ...
          <select className="form-select col-sm-6" id="membershipStatus" name="membershipStatus" value={membershipStatus} onChange={(e) => handleInputChange(e)}>
